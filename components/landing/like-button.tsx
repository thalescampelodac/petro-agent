...
export function LikeButton() {
  ...
  return (
    <div className="flex max-w-[12.5rem] flex-col items-end gap-2 text-right sm:max-w-none">
      <button
        aria-label="Gostei do projeto"
        className={cn(
          "group flex w-full items-center justify-between gap-2 rounded-md border border-emerald-300/25 bg-emerald-300 px-3 py-2 text-xs font-semibold text-emerald-950 shadow-lg shadow-emerald-950/20 transition duration-200 hover:-translate-y-0.5 hover:bg-emerald-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-200 sm:w-auto sm:gap-3 sm:px-4 sm:text-sm",
      ...
      >
        <span className="flex min-w-0 items-center gap-2">
          ...
          />
          <span className="truncate">Gostei do projeto</span>
        </span>
